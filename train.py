...
if __name__ == '__main__':
    ...
    val_losses, val_accs, test_accs, test_macro_f1s  = tensor(val_losses), tensor(val_accs), tensor(test_accs), tensor(test_macro_f1s)

    print('Val Loss: {:.4f} ± {:.3f}, Val Accuracy: {:.3f} ± {:.3f}, Test Accuracy: {:.3f} ± {:.3f}, Macro-F1: {:.3f} ± {:.3f}'.
